		...
		return (
			<Styles>
				...
				<Form className='form-body' noValidate validated={validated} onSubmit={handleSubmit}>
					...
					<a className="change-screen" href="/log-in">Have an account, click here</a>
					...
					<Form.Row>
						<Form.Group as={Col} md="6" controlId="validationCustom01">
							...
							<Form.Control type="date" name='birth' onChange={handleChange} value={input.birth} required />
							<Form.Control.Feedback>Looks good!</Form.Control.Feedback>
						</Form.Group>
						<Form.Group as={Col} md="6" controlId="validationCustom02">
							<Form.Label>Gender*</Form.Label>
							<Form.Control as="select" defaultValue="Choose..." onChange={handleChange} value={input.gender} name="gender" required >
					...
					<Form.Row>
						...
						<Form.Group as={Col} md="3" controlId="validationCustom03">
							...
							<Form.Control type="text" placeholder="City" onChange={handleChange} value={input.city} name="city" required />
							<Form.Control.Feedback type="invalid">
						...
						<Form.Group as={Col} md="3" controlId="validationCustom04">
							...
							<Form.Control as="select" defaultValue="Choose..." onChange={handleChange} value={input.state} name="state" required >
						...
						<Form.Group as={Col} md="3" controlId="validationCustom05">
							...
							<Form.Control type="text" placeholder="Zip" onChange={handleChange} value={input.zip} name="zip" required />
							<Form.Control.Feedback type="invalid">
					...
					<Form.Row>
						...
						<Form.Group as={Col} md="3" controlId="validationCustom03">
							...
							{address ? (
								<Form.Control
									type="text" placeholder="City" onChange={handleChange} value={input.cityShip} name="cityShip" required
								/>
							) : (
								<Form.Control
									type="text" placeholder="City" value={input.city} onChange={handleChange} disabled
								/>
						...
						<Form.Group as={Col} md="3" controlId="validationCustom04">
							...
							{address ? (
								<Form.Control
									as="select" defaultValue="Choose..." onChange={handleChange} value={input.stateShip} name="stateShip" required >
									<option>Alabama</option>
									<option>Alaska</option>
									<option>Arizona</option>
									<option>Arkansas</option>
								...
								<Form.Control
									as="select" defaultValue="Choose..." value={input.state} onChange={handleChange} name="stateShip" disabled >
									<option>Alabama</option>
									<option>Alaska</option>
									<option>Arizona</option>
									<option>Arkansas</option>
						...
						<Form.Group as={Col} md="3" controlId="validationCustom05">
							...
							{address ? (
								<Form.Control
									type="text" placeholder="Zip" onChange={handleChange} value={input.zipShip} name="zipShip" required
								/>
							) : (
								<Form.Control
									type="text" placeholder="Zip" onChange={handleChange} value={input.zip} name="zipShip" disabled
								/>
							)}
							<Form.Control.Feedback type="invalid">
								Please provide a valid zip.
					...
					<Form.Row>
						...
						<Form.Group as={Col} md="6" controlId="validationCustom04">
							...
							<Form.Control as="select" defaultValue="Choose..." onChange={handleChange} value={input.react} name="react" >
								<option>Choose...</option>
